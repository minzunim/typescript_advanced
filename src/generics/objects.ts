import { MyinterfaceG } from "../types";
...
const okayGeneric: ReadonlyArray<boolean> = [false]; // ReadonlyArray<boolean>이라는 유틸리티 함수 사용
...
const numberObjectG: MyinterfaceG<number> = { value: 123 };
